...
public class DTOCarAccessoryForAddAndUpdate {
	private String name;
	private int price;
	...
	public DTOCarAccessoryForAddAndUpdate(String name, int price, String statusDamaged, String repairStatus) {
		this.name = name;
		this.price = price;
		this.statusDamaged = statusDamaged;
		this.repairStatus = repairStatus;
	}
	public DTOCarAccessoryForAddAndUpdate() {
	}
